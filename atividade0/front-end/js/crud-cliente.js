$(function () {
    ...
    if ($('table').length) {
        $.get("http://localhost:5000/api/cliente").done(function (dados) {
    ...
    $("form").on("submit", function (event) {
        ...
        if (parametrosDaUrl) {
            ...
            var url = "http://localhost:5000/api/cliente" + parametrosDaUrl;
            $.ajax({
                url: url,
                method: "PUT",
                data: datastring,
                ...
                window.location.href = "http://localhost:8080/clientes.html";
            }).fail(function (e) {
                console.log(e);
            });
        } else {
